    ...
    ) !GraphicsPipeline
{
    ...
    std.log.info("local_size_x = {}, local_size_y = {}, local_size_z = {}", .{ shader_parse_result.local_size_x, shader_parse_result.local_size_y, shader_parse_result.local_size_z });
