...
pub fn main() !void {
    ...
    _ = try std.os.inotify_add_watch(file_notify_fd, std.fs.path.dirname(app_lib_file_path).?, std.os.linux.IN.CLOSE_WRITE | std.os.linux.IN.NONBLOCK | std.os.linux.IN.DELETE | std.os.linux.IN.EXCL_UNLINK | std.os.linux.IN.CREATE);
